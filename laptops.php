		...
		<div id="container">
		 	<div class="row">
		 		<div class="col-md-push-1 col-md-8">
		 			<ul >
	            		<li class="list">
	            			<img height="350" width="300" src= "Uploads/DELL.jpg.JPG">
	            			<p><?php get_data('30'); ?></p>
	            		</li >
	            		<li class="list">
	            			<img height="350" width="300" src= "Uploads/HP.png.JPG">
	            			<p><?php get_data('31'); ?></p>
	            		</li>
	            		<li class="list">
	            			<img height="350" width="300" src= "Uploads/Mac Book.jpg.JPG">
	            			<p><?php get_data('32'); ?></p>
	            		</li>
	            		<li class="list">
	            			<img height="350" width="300" src="Uploads/samsung.jpg.JPG">
	            			<p><?php get_data('33'); ?></p>            				
	            		</li>
	            		<li class="list">
	            			<img height="350" width="300" src="Uploads/Toshiba.jpg.JPG">
	            			<p><?php get_data('34'); ?></p>            				
	            		</li>
	            	</ul>	
				</div>
